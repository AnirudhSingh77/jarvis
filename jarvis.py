...
def wishMe():
    ...
    if hour>= 0 and hour< 12:
        a = "Good morning Anirudh", "Good morning sir", "Hello Anirudh Good Morning", "O, Good morning sir", "O, good morning Anirudh", "Wow! Welcome back Anirudh sir"
        speak(random.choice(a))
    elif hour>= 12 and hour< 18:
        b = "Good Afternoon Anirudh", "Good Afternoon sir", "Hello Anirudh Good Afternoon", "O, Good Afternoon sir", "O, good Afternoon Anirudh", "Wow! Welcome back Anirudh sir"   
        speak(random.choice(b))
    else:
        
        c = "Good Evening Anirudh", "Good Evening sir", "Hello Anirudh Good Evening", "O, Good Evening sir", "O, good Evening Anirudh", "Wow! Welcome back Anirudh sir"
...
if __name__ == '__main__':
    while True:
        ...
        if 'stop' in query or 'over' in query or 'bye' in query or 'quit' in query or 'see you' in query or 'go' in query:
            ...
            jh = "if you are speaking then, definately you are a human", "You are Anirudh", "You are a human", "I cant identify peoples with their vocies, may be you are Anirudh or anybody with relation of Anirudh"
